var config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      alignment: "left",
      hidden: false,
      title: "Springfield Obesity",
      image: "https://upload.wikimedia.org/wikipedia/commons/b/b9/Volunteers_assist_food_bank_DVIDS1099792.jpg",
      description: "<p class='source'>Source: <a target='_blank' href=’https://commons.wikimedia.org/wiki/File:Volunteers_assist_food_bank_DVIDS1099792.jpg’>Public Domain, by Petty Officer 3rd Class Robert Brazzell</a></p>Obesity in Springfield is among the highest in the state, with an estimated 36% of individuals classified as obese in the city. This falls in line with the income and depression statistics as the city also holds a spot on the most depressed cities in the country as of 2022 and is one of the lowest earning areas per capita. A number of factors are thought to be at work that contribute to this number, primary among them the lack of grocery stores readily available for most neighborhoods. There have been efforts to tackle the obesity problem in Springfield specifically, with nearly one million in state funding being allocated to the distribution of healthy, locally-grown foods in 2022; it remains to be seen if this and similar efforts will create lower rates of obesity in the area.",
      location: {
        center: [-72.53952002, 42.11550322],
        zoom: 11,
        pitch: 0,
