var config = {
  ...
  footer:'Sources: <br>Research: <br><a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5775138/">Income inequality and depression: a systematic review and meta‐analysis of the association and a scoping review of mechanisms</a> <br><a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4939441/">The Relationship between Childhood Obesity, Low Socioeconomic Status, and Race/Ethnicity: Lessons from Massachusetts</a><br><a href="https://www.hsph.harvard.edu/news/features/asthma-obesity-boston-communities/">Tackling the asthma-obesity link in Boston | News | Harvard T.H. Chan School of Public Health</a> <br><a href="https://www.wbur.org/news/2022/08/08/2022-kids-count-survey-massachusetts-ranks-first-anxiety-rises">Massachusetts kids overall well-being is trending up. So are anxiety and depression rates</a><br><a href="https://www.cdc.gov/nccdphp/dch/programs/communitiesputtingpreventiontowork/communities/profiles/both-ma_boston.html">CDC - Community Profile - Boston, MA - Communities Putting Prevention to Work</a> <br><a href="https://www.wgbh.org/news/2017/08/31/local-news/massachusetts-obesity-rates-among-nations-lowest">Massachusetts Obesity Rates Among Nations Lowest</a>  <br><a href="https://www.masslive.com/springfield/2022/10/square-one-receives-993k-grant-to-provide-locally-grown-food-to-children-and-families.html">Locally Grown food Grant for Springfield, MA</a> <br><a href="https://www.baystatebanner.com/2011/11/16/a-question-of-access/">A question of access - The Bay State Banner</a> <br><a href="https://valleyadvocate.com/2015/11/09/food-deserts-of-springfield/">Food Deserts of Springfield</a> <br><a href="https://www.newtonma.gov/government/health-human-services/social-services/food-resources">Newton Freedge</a> <br> Data: <br><a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6195011/">Identifying Stress Landscapes in Boston Neighborhoods</a> <br><a href="https://chronicdata.cdc.gov/500-Cities-Places/PLACES-Place-Data-GIS-Friendly-Format-2022-release/vgc8-iyc4">CDC Place Data</a>  <br><a href=" https://www.census.gov/topics/income-poverty/income/data/tables.html">Census Income Data</a><br><a href="https://commons.wikimedia.org/wiki/File:Newton_City_Hall,_Massachusetts.jpg">Kenneth C. Zirkel</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0">CC BY-SA 4.0</a>, <br> Created using <a href="https://github.com/mapbox/storytelling" target="_blank">Mapbox Storytelling</a> template. <br><a href="https://commons.wikimedia.org/wiki/File:Boston,_1775bsmall1.png">Thomas Hyde Page</a>, <a href="https://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> <br>  <br>',

    // <br> <a href=""></a>
    // <p class='source'><p class='source2'></p>Source: <a target='_blank' insert attribution here </p>
  ...
  chapters: [
    ...
    },
    {
      ...
      description:
        "<p class='source'>Source: <a target='_blank' <a href=’https://commons.wikimedia.org/wiki/File:Boston_Financial_District_skyline.jpg’>Public Domain by Nelson48</a> </p>While Massachusetts boasts some of the highest average income levels in the country, there are still areas throughout the state that suffer from much lower tax brackets. Within these areas both obesity and depression have a tendency to be on the higher end of state metrics, particularly in spots without proper access to grocery stores and/or medical intervention. This is concentrated in the western half of the state, though the disparity can also be found in certain areas of Boston Metro. The income disparity is most prevalent in suburban Boston, with areas like Newton reaching nearly four times the median icome of western cities like Springfield.",
    ...
    },
    {
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/6/60/Hms-quad.jpg",
      description: "<p class='source'>Source: <a target='_blank'href=’https://commons.wikimedia.org/wiki/File:Hms-quad.jpg’>JosephBarillari</a>, <a href=’http://creativecommons.org/licenses/by-sa/3.0/’>CC BY-SA 3.0</a></p>Depression is prevalent in the United States, and has been shown to spike in areas of lower socio-economic status and obesity, though these are by no means the only driving factors. Depression is an extremely complex disease and research on it, though well-funded, has yet to make the breakthrough that solves this increasingly large issue. Depression is also an area where Massachusetts is better than average on the national scale. While this is a positive statistic, the number of young adults diagnosed with depression/anxiety has risen by more than 50% since 2016 per the Kids Count data book report in 2022. Data from Blue Cross Blue Shield shows that millennials in particular are more likely than any other state to be diagnosed with depression, contradicting the rest of the population. Though Massachusetts ranks on the lower end of nationwide depression, Springfield and Boston both still hold higher than average percentages.",
      location: {
        center: [-71.925258, 42.377117],
        zoom: 8,
        pitch: 0,
    ...
    },
    {
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/b/b9/Volunteers_assist_food_bank_DVIDS1099792.jpg",
      description: "<p class='source'>Source: <a target='_blank' href=’https://commons.wikimedia.org/wiki/File:Volunteers_assist_food_bank_DVIDS1099792.jpg’>Public Domain, by Petty Officer 3rd Class Robert Brazzell</a></p>Obesity in Springfield is among the highest in the entire country, with an estimated 36% of individuals classified as obese in the city. This falls in line with the income and depression statistics as the city also holds a spot on the most depressed cities in the country as of 2022 and is one of the lowest earning areas per capita. A number of factors are thought to be at work that contribute to this number, primary among them the lack of grocery stores readily available for most neighborhoods. There have been efforts to tackle the obesity problem in Springfield specifically, with nearly one million in state funding being allocated to the distribution of healthy, locally-grown foods in 2022; it remains to be seen if this and similar efforts will create lower rates of obesity in the area.",
      location: {
        center: [-72.53952002, 42.11550322],
        zoom: 11,
        pitch: 0,
...

    {
      ...
      hidden: false,
      title: "Newton Income",
      image: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Windermere_Rd%2C_Newton_MA.jpg",
      description: "<p class='source'>Source: <a target='_blank' href=’https://commons.wikimedia.org/wiki/File:Windermere_Rd,_Newton_MA.jpg’>John Phelan</a>, <a href=’https://creativecommons.org/licenses/by/3.0’>CC BY 3.0</a></p>Newton is recognized as one of the most affluent towns in the entire country with a median income of nearly $185,000. This affords an extremely high tax bracket, allowing for incredibly well-funded schools and public health education programs. Newton is roughly eight miles outside Boston city center, the perfect location for those with high-income positions in the city but far enough away to utilize the suburban landscape. Driving through the area it is obvious the wealth relative to other areas in the state, with perfectly manicured gardens and boutique shops lining the main streets. Because of their extremely high tax bracket it is nearlyimpossible to live in the area without a substantial income. Though there are lower income areas, their income level is relative only to the town itself.",
      location: {
    ...
    },
    {
      ...
      image: "https://newtonfoodpantry.org/wp-content/uploads/2021/11/freedge-Past-Article-Art-1024x681.jpg",
      description: "<p class='source'>Source: <a target='_blank'href= ‘https://newtonfoodpantry.org/free-refrigerator-pantry-newton-community-freedge/’>Steven Sulewski</a>, <a href=’ https://www.stevensulewski.com/’>Steven Sulewski Photography</a></p>Newton Obesity rates are also among the lowest in the state, ranking higher than only Lexington and Williamstown. This makes sense as the area houses both a highly prestigious hospital in the Newton-Wellesley Hospital system and an overabundance of food stores; several which like Whole Foods, Trader Joe’s and Mom’s Organic Market provide health-focused options. There is also the Freedge, a free service for the area that provides household essentials to any resident, no questions asked.",
      location: {
        center: [-71.20842576, 42.33160123],
        zoom: 11,
        pitch: 0,
    ...
    },
    {
      ...
      alignment: "left",
      hidden: false,
      title: "Dorchester/South Boston Obesity",
      image: "https://upload.wikimedia.org/wikipedia/commons/8/82/Dorchester_Community_Fridge.jpg",
      description: "<p class='source'>Source: <a target='_blank'href=’https://commons.wikimedia.org/wiki/File:Dorchester_Community_Fridge.jpg’>Saaadu18</a>, <a href=’https://creativecommons.org/licenses/by-sa/4.0’>CC BY-SA 4.0</a></p>The South Boston neighborhoods are also higher than the surrounding areas with regards to obesity rates, with Dorchester reporting 31% of individuals as obese compared with 21% in the city overall. This is primarily due to the lack of healthy food stores in the area. Though it fares better than areas more removed from distribution centers (see Springfield, MA) it is still on the higher end of the state when compared to more connected and affluent neighborhoods. Food access and insecurity is a continuing issue in much of the world, and even neighborhoods in large, wealthy American cities are not immune.",
      location: {
        center: [-71.072105, 42.302708],
        zoom: 11,
        pitch: 0,
